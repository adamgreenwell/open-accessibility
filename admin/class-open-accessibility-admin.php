		...
		foreach ($icons as $value => $label) {
			...
			switch ($value) {
				case 'open-accessibility':
					echo '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="24" height="24" aria-hidden="true">
                    <circle cx="50" cy="50" r="50" fill="' . esc_attr($preview_color) . '"/>
                    <g fill="#4054b2">
				...
				case 'international':
					echo '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 343 340" aria-hidden="true">
                    <g fill="' . esc_attr($preview_color) . '">
